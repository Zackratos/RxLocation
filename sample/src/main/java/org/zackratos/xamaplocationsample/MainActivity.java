package org.zackratos.xamaplocationsample;
...
import org.zackratos.xmaplocation.LocationMode;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                XMapLocation.newBuilder(MainActivity.this)
                        .build()
    ...
    private void startLocate() {
        XMapLocation.newBuilder(MainActivity.this)
                .locationMode(LocationMode.Device_Sensors)   //定位模式，默认值是 LocationMode.Height_Accuracy
                ...
                .build()
                .locate(new LocateListener() {               //监听定位结果
                    @Override
                    public void onLocated(Location location) {
